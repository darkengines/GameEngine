...
addMeshes() {
	return fruit::createComponent()
		.registerConstructor<Resources::MeshResourceManager(Buffers::Resources::BufferResourceManager & bufferResourceManager)>()
		.registerConstructor<Systems::MeshSystem(
		...
		.registerConstructor<Systems::MeshShadowSystem(
			entt::registry & registry,
			Engine::EngineState & engineState
		)>()
		.registerFactory<std::unique_ptr<Meshes::Pipelines::MeshPipeline>(
			const Devices::DeviceContext& deviceContext,
			Engine::EngineState& engineState,
			...
			return std::make_unique<Meshes::Pipelines::MeshPipeline>(
				deviceContext,
				engineState,
				descriptorSetLayouts
			);
		})
		.registerFactory<std::unique_ptr<Pipelines::ShadowMeshPipeline>(
			const Devices::DeviceContext& deviceContext,
			Engine::EngineState& engineState,
			const Engine::DescriptorSetLayouts& descriptorSetLayouts
		)>([](
			...
			return std::make_unique<Pipelines::ShadowMeshPipeline>(
				deviceContext,
				engineState,
				descriptorSetLayouts
			);
